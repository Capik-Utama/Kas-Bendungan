...
export default function RiwayatPage() {
  ...
  function printReport() {
    window.document.title = `Laporan Kas - ${formatNamaFile(periodLabel)}`;
    window.print();
  }
  ...
  async function exportExcel() {
    ...
    try {
      ...
      XLSX.writeFile(workbook, `laporan-kas-${formatNamaFile(periodLabel)}.xlsx`);
    } finally {
      setExporting(false);
    }
  }
