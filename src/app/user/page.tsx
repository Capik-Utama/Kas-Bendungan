...
export default function UserPage() {
  ...
  const belongsToSelectedGroup = (item: Profile) => selectedGroup === "Semua" || (item.profile_kelompok || []).some((membership) => groups.find((group) => group.id === membership.kelompok_id)?.nama === selectedGroup);
