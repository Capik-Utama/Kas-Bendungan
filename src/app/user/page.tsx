...
export default function UserPage() {
  ...
  const [fields, setFields] = useState<OptionalFields>(emptyFields); const [editing, setEditing] = useState<Profile | null>(null); const [notice, setNotice] = useState(""); const [error, setError] = useState("");
